...
//        if (this.header)
        ...
        Iterator rowIterator = vecBody.iterator();//this.model.getRowIterator(this.exportFull);
...
*/
            // iterator on columns
            Iterator columnIterator = row.iterator();//row.getColumnIterator(this.model.getHeaderCellList());
            ...
            while (columnIterator.hasNext())
            {
               // Column column = columnIterator.nextColumn();
                ...
                String value = escapeColumnValue(column);//(column.getValue(this.decorated));
