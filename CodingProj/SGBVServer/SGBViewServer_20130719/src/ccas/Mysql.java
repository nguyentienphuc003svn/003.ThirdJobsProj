...
*/
	...
	private DataSource getDataSource(String myjndi)	{	 //throws Exception
		CLog.writeLog(new Exception().getStackTrace()[0].getClassName()+":"+new Exception().getStackTrace()[0].getMethodName()+",jndi:"+myjndi);
		this.myjndi=myjndi;
		try	{
			if	(dataSource == null){
...
*/
	...
	////////--------
	public ResultSet getRowSqlRS(String sql) throws Exception	
	{
		ResultSet rsMHB = null;
		
		if	(sql==null || sql.length()<=0) return	rsMHB;
